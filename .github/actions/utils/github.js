    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                headers = new node_fetch_1["default"].Headers();
...
exports.githubRest = function (method, url, body) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                headers.append('Content-Type', 'application/json');
                headers.append('Authorization', 'Bearer ' + token);
                return [4 /*yield*/, node_fetch_1["default"]('https://api.github.com' + url, {
                        method: method,
                        mode: 'cors',
                        cache: 'no-cache',
                        headers: headers,
