...
exports.Pr = exports.getPr = void 0;
var github_1 = require("./github");
exports.getPr = function (mergeBranch, repo) { return __awaiter(void 0, void 0, void 0, function () {
    var number, pr;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                number = parseInt(mergeBranch.split('/')[2]);
                pr = new Pr(number, repo);
                return [4 /*yield*/, pr.loadInfo()];
            case 1:
                _a.sent();
                return [2 /*return*/, pr];
        }
...
var Pr = /** @class */ (function () {
    ...
    Pr.prototype.leaveComment = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
